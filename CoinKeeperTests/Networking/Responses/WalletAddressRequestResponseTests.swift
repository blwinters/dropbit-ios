...
class WalletAddressRequestResponseTests: XCTestCase, ResponseStringsTestable {
  ...
  func testNilAmountsThrowError() {
    ...
    let nilBTCAmount = MetadataAmount(btc: nil, usd: 100, fiatAmount: 100, fiatCurrency: "USD")
  ...
  func testZeroAmountsThrowError() {
    ...
    let zeroBTCAmount = MetadataAmount(btc: 0, usd: 100, fiatAmount: 100, fiatCurrency: "USD")
  ...
  func testNegativeAmountsThrowError() {
    ...
    let negativeBTCAmount = MetadataAmount(btc: -1, usd: 100, fiatAmount: 100, fiatCurrency: "USD")
  ...
  func testPositiveAmountsDoNotThrowError() {
    ...
    let zeroBTCAmount = MetadataAmount(btc: 10_000, usd: 100, fiatAmount: 100, fiatCurrency: "USD")
  ...
  func testMaxSatoshiThrowsError() {
    ...
    let maxBTCAmount = MetadataAmount(btc: MAX_SATOSHI, usd: 100, fiatAmount: 100, fiatCurrency: "USD")
